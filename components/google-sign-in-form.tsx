...
export function GoogleSignInForm() {
  ...
  if (user || isLoading) {
    return (
      <div className="flex min-h-40 w-full flex-col items-center justify-center gap-3 text-center">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            {user
              ...
              : "We are loading your account so we can send you to the right place."}
          </p>
        </div>
      </div>
    );

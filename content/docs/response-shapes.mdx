...
const response = await fetch(
  'https://api.vinecms.online/api/public/{API_KEY}/posts'
);
const data: PostListResponse = await response.json();

// Fetch a single post
const postResponse = await fetch(
  'https://api.vinecms.online/api/public/{API_KEY}/posts/my-post-slug'
);
const post: PostDetail = await postResponse.json();

// Fetch tags
const tagsResponse = await fetch(
  'https://api.vinecms.online/api/public/{API_KEY}/tags'
);

...
```
GET https://api.vinecms.online/api/public/v1/{API_KEY}/tags
```

## Example Request

```bash
curl "https://api.vinecms.online/api/public/v1/{API_KEY}/tags"
```
...
const response = await fetch(
  'https://api.vinecms.online/api/public/v1/{API_KEY}/tags'
);
...
curl "https://api.vinecms.online/api/public/{API_KEY}/posts?tags=guides"

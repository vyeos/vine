...
```
GET https://api.vinecms.online/api/public/v1/{API_KEY}/authors
```

## Example Request

```bash
curl "https://api.vinecms.online/api/public/v1/{API_KEY}/authors"
```
...
const response = await fetch(
  'https://api.vinecms.online/api/public/v1/{API_KEY}/authors'
);

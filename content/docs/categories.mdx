...
```
GET https://api.vinecms.online/api/public/v1/{API_KEY}/categories
```

## Example Request

```bash
curl "https://api.vinecms.online/api/public/v1/{API_KEY}/categories"
```
...
const response = await fetch(
  'https://api.vinecms.online/api/public/v1/{API_KEY}/categories'
);
...
curl "https://api.vinecms.online/api/public/v1/{API_KEY}/posts?category=product"
```
